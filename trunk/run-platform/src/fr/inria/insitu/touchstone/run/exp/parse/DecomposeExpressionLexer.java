// $ANTLR : "decomposeExpressions.g" -> "DecomposeExpressionLexer.java"$
...
public class DecomposeExpressionLexer extends antlr.CharScanner implements DecomposeExpressionParserTokenTypes, TokenStream
 {
public DecomposeExpressionLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public DecomposeExpressionLexer(Reader in) {
	this(new CharBuffer(in));
}
public DecomposeExpressionLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public DecomposeExpressionLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { -549755823105L, -268435457L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { -17179878401L, -2305843009482129409L, 0L, 0L};
		return data;
	}
