// $ANTLR : "axisExpr.g" -> "AxisExprLexer.java"$
...
public class AxisExprLexer extends antlr.CharScanner implements AxisExprParserTokenTypes, TokenStream
 {
public AxisExprLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public AxisExprLexer(Reader in) {
	this(new CharBuffer(in));
}
public AxisExprLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public AxisExprLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("min", this), new Integer(29));
	literals.put(new ANTLRHashString("sqrt", this), new Integer(28));
	literals.put(new ANTLRHashString("abs", this), new Integer(27));
	literals.put(new ANTLRHashString("MIN_VALUE", this), new Integer(25));
	literals.put(new ANTLRHashString("hypot", this), new Integer(32));
	literals.put(new ANTLRHashString("max", this), new Integer(31));
	literals.put(new ANTLRHashString("MAX_VALUE", this), new Integer(26));
	literals.put(new ANTLRHashString("diff", this), new Integer(34));
	literals.put(new ANTLRHashString("int", this), new Integer(33));
}
